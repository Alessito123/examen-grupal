export type PlanEstudiosCursoSeed = {
  codigo: string;
  ciclo: number;
  tipoPlan: string;
  nombre: string;
...
const PLAN_ESTUDIOS_2018_RAW = `
1939|1|S|INTRODUCCION A LA INGENIERIA DE SISTEMAS|3|2|0|2|INGENIERIA DE SISTEMAS
...
export const planEstudios2018: PlanEstudiosCursoSeed[] = PLAN_ESTUDIOS_2018_RAW
  .trim()
  .split('\n')
  .map((line) => {
    const [
