...
const ModalPDF: React.FC<ModalPDFProps> = ({ isOpen, onClose, pdfUrl }) => {
  return (
    <AnimatePresence>
      {isOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-8 py-5 border-b border-gray-200 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.01]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 dark:text-white text-base">Vista Previa del Documento</h3>
                  <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">Previsualización en tiempo real del PDF generado</p>
                </div>
              </div>
